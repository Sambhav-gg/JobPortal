...
const JobDescription = () => {
    ...
    const fetchSingleJob= async()=>{
        try{
            ...
            if(res.data.success){
                ...
                setIsApplied(res.data.job.applications.some(application=>application.applicant === user?._id))//ensure the state is in ync with fetched data
            }
  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      ...
      <h1 className="border-b-2 border-v-gray-300 font-medium py-4">{singleJob?.description}</h1>
      <div className="my-4">
